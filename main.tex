...
\Abstract{The extended narrow-line region (ENLR) is a puzzling structure of highly ionized gas, with a typical conical or bi-conical shape. 
...
Mrk 783 is the first narrow-line Seyfert 1 galaxy NLS1 showing both a kiloparsec scale radio emission and an ENLR, which is the most extended ENLR discovered so far at low redshift (R $\sim 38$ kpc).
The galaxy shows also hints of a recent merging.
Understanding the origin of the ENLR and its relation with the merging event will be fundamental to improve our knowledge of ENLR and of the role of merging in the life of AGN.

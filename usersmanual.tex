...
%%% To Dimitri: check next item every period for instruments with PWV requirements %%%
...
%$^3$ GRAVITY is only offered in spectro-imaging mode for Monitoring Programmes.\\
...
%%% To Dimitri: uncomment line below every odd period %%%
...
SECTIONS CAN VARY. ALL TEXT AND FIGURES MUST FIT WITHIN A TOTAL
...
%%% To Dimitri: uncomment the following line in odd periods %%%
%{\bf However, if you are submitting a VLT-XMM proposal all targets should be included}.
%%%
...
%%% To Dimitri: check every period in the paragraph below for instruments using NGS, %%%
%%% TTS or Fringe Tracking Stars %%%
...
%$^3$ GRAVITY is only offered in spectro-imaging mode for Large Programmes.\\
